	  				...
	  				<?php foreach($clients as $client): ?>	  					
	  					<tr>
		  					...
		  					<td>
								...
								<!-- Editar -->
								<a href="editaClientes.php?id=<?=$client['id_client'];?>" class="btn btn-warning btn-xs">
								  ...
								  <div class="modal-dialog">
								    ...
								    <div class="modal-content">
								      ...
								      <div class="modal-body">
								        Deseja excluir o produto <strong><?=$client['client_name'];?></strong>? Essa alteração não pode ser desfeita!

								        <input type="hidden" name="table" class="form-control" required placeholder="Digite o nome" value="clients">
